...
// Create elements for text areas, and link to html elements
...
// Define empty array to store search history

let cities = [];

// searchHistory function grabs the cityList element, and sets it's textcontent to an empty string to start
...
function searchHistory(city) {
  ...
  cities.forEach(function (city) {
    ...
    // when cityButton is clicked, searchWeather function runs with city (associated value in the search history list)

    cityButton.addEventListener("click", function () {
      let city = this.firstChild.nodeValue;
      searchWeather(city);
    });
...
// search weather executes a fetch call to query the api with the user search term + the APIKey
...
// On click, if user input is not an empty string
// user input is pushed as city into cities (search history list)
// then searchWeather is ran with city being the user input
...
// Clear button on click resets cityList to empty string, and reloads the page
